...
download it at https://moodle.org/plugins/view.php?plugin=block_ejsapp_collab_session, in the plugins section in the
Moodle.org webpage or at https://github.com/UNEDLabs.

An explanation of EJSApp and EJSApp Collab Session is included in the folder "doc". There, you will also find a txt file
with relevant links.
